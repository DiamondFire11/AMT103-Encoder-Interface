...
const PinDescription g_APinDescription[]=
{
  ...
  // Digital 11 (CAN-FD Controller Interrupt)
  { PORTA, 11, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC1_CH1, EXTERNAL_INT_11 },

  // Digital 16, 17, 18 (Same Sky AMD103 encoder A, B, and X inputs)
  { PORTA, 16, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC2_CH0, EXTERNAL_INT_0 },
  { PORTA, 17, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC2_CH1, EXTERNAL_INT_1 },
